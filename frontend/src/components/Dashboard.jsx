                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                      <div className="glass-panel glass-glow-hover p-6">
                        ...
                        <div className="w-full">
                          {loading || !rqData ? (
                            <div className="h-64 flex items-center justify-center text-white/30 animate-pulse">Stabilizing Results... (Running 1125 Scenarios)</div>
                          ) : (
                            <Heatmap data={rqData.data} optimalRq={rqData.optimal_rq} currentR={params.R_a} currentQ={params.Q_a} onApply={handleApplyOptimal} />
                          )}
                        </div>
                      </div>
